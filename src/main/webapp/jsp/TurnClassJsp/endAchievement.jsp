...
<script type="text/javascript">
	...
	function ll() {
		...
		$
				.ajax({
					async : false,
					cache : false,
					url : "${pageContext.request.contextPath}/turnClass/statusCheckoutEnd?teamId="
	...
	function submitButton() {
		var path = "${pageContext.request.contextPath}/turnClass/insertEndAchievement/"
				+ nowStage;
	...
	function changeInfo(category) {
		...
		$
				.ajax({
					async : false,
					cache : false,
					url : "${pageContext.request.contextPath}/turnClass/getInfoForTeamEndAchievement?teamId="
							+ teamId
							+ "&taskId="
							+ taskId
							+ "&category="
